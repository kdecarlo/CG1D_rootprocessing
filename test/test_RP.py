...
class TestClass(unittest.TestCase):
    ...
    def test_allimagesequal(self):
        ...
        stitch_image_ideal = Image.open(wd+'/test/Sample_Data_ideal/stitched/SampleImg_stitched.tiff')
        ...
        crop_image_ideal = Image.open(wd+'/test/Sample_Data_ideal/crop/SampleImg_crop.tiff')
        ...
        wc_image_ideal = Image.open(wd+'/test/Sample_Data_ideal/wc/SampleImg_wc.tiff')
        ...
        mask_image_ideal = Image.open(wd+'/test/Sample_Data_ideal/mask/SampleImg_mask.tiff')
        ...
        filter_image_ideal = Image.open(wd+'/test/Sample_Data_ideal/mask_filter/SampleImg_filter.tiff')
        ...
        distmap_image_ideal = Image.open(wd+'/test/Sample_Data_ideal/distmap/SampleImg_distmap.tiff')
        self.assertTrue(np.array_equal(distmap_image, distmap_image_ideal))
    
    
        self.assertTrue(filecmp.cmp(wd+'/Sample_Data_unittest/radwc/SampleImg/SampleImg_data_distrange.txt', wd+'/test/Sample_Data_ideal/radwc/SampleImg/SampleImg_data_distrange.txt'))
        self.assertTrue(filecmp.cmp(wd+'/Sample_Data_unittest/radwc/SampleImg/SampleImg_data_num_xrad_ydist_wc.txt', wd+'/test/Sample_Data_ideal/radwc/SampleImg/SampleImg_data_num_xrad_ydist_wc.txt'))
        self.assertTrue(filecmp.cmp(wd+'/Sample_Data_unittest/radwc/SampleImg/SampleImg_data_radrange.txt', wd+'/test/Sample_Data_ideal/radwc/SampleImg/SampleImg_data_radrange.txt'))
        self.assertTrue(filecmp.cmp(wd+'/Sample_Data_unittest/radwc/SampleImg/SampleImg_data_xrad_ydist_wc.txt', wd+'/test/Sample_Data_ideal/radwc/SampleImg/SampleImg_data_xrad_ydist_wc.txt'))
            
    
        thickness_image = Image.open(wd+'/Sample_Data_unittest/thickness/SampleImg_thickness.tiff')
        thickness_image_ideal = Image.open(wd+'/test/Sample_Data_ideal/thickness/SampleImg_thickness.tiff')
        ...
        ri_image_ideal = Image.open(wd+'/test/Sample_Data_ideal/rootimage/SampleImg_rootimage.tiff')
